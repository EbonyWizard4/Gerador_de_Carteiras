...
def Do_docx():
    ...
    tabela = pd.read_csv('magicForm.csv')
    ...
    hdr_cells[2].text = 'EV/EBIT'
    hdr_cells[3].text = 'ROIC'
    hdr_cells[4].text = 'Liq_2Meses'
    hdr_cells[5].text = 'Ranking'
    ...
    document.save('Carteiras/MagicForm.docx')
Do_docx()